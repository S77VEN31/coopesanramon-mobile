...
interface DinersLogoProps {
  width?: number;
  height?: number;
}

export default function DinersLogo({ width = 60, height = 40 }: DinersLogoProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 780 500" fill="none">
      <Path d="M40 0h700c22.092 0 40 17.909 40 40v420c0 22.092-17.908 40-40 40H40c-22.091 0-40-17.908-40-40V40C0 17.909 17.909 0 40 0z" fill="#0079BE" />
