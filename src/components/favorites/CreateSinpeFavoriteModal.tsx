...
import { TwoFactorStep, SinpeAccountSearchStep, FavoriteDataStep } from '@/components/wizard/steps';
...
export default function CreateSinpeFavoriteModal() {
  ...
  useEffect(() => {
    if (isCreateModalOpen && !currentChallenge && !isCreatingChallenge && !has2FAStepBeenInitialized && destinationAccount && alias !== undefined) {
      ...
      createdesafio(TipoOperacion.CreacionCuentaFavoritaSinpe).then((challenge) => {
      ...
      <View style={styles.modalBackdrop}>
        ...
        <View style={[styles.modalContent, { backgroundColor }]}>
          <View style={[styles.modalHeader, { borderBottomColor: borderColor }]}>
            <Text style={[styles.modalTitle, { color: colorScheme === 'dark' ? '#ffffff' : '#a61612' }]}>{FAVORITE_TEXTS.CREATE_SINPE_TITLE}</Text>
